...
export default function App() {
  ...
  // Reset confetti shown flag if Brand New Day gets unwatched
  useEffect(() => {
    if (!watchedIds.includes(83)) {
      brandNewDayShown.current = false
    }
  }, [watchedIds])
  ...
  return (
    <div className="min-h-screen bg-bg">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        {activeTab === 'entries'      && <EntriesView entries={entries} onToggle={handleToggle} />}
        {activeTab === 'timeline'     && <TimelineView entries={entries} onToggle={handleToggle} />}
        {activeTab === 'posterwall'   && <PosterWall entries={entries} onToggle={handleToggle} />}
